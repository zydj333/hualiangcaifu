...
class Orderreserve extends Admin_Controller {
	...
	*/
    ...
    $seldata['pagesize']=10;
		...
		$list=$this->a_caifu_model->get_orderreserve_search($seldata);
	  ...
	  $this->cismarty->display('caifu/orderreserve/order_list.html');
	}
	...
	public function order_view(){
		...
		if(isset($_POST['dosubmit'])){
		  ...
		  $this->cismarty->display('caifu/orderreserve/order_info.html');
		}
	}
	 //删除
