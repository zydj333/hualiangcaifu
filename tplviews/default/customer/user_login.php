...
<title>登录_华良财富-中国最大最专业的理财师一站式服务平台</title>
...
<header>
    <div class="lr_head">
        <div class="lr_head_top">
            <a href="index.php"><img src="<!--{IMG_PATH}-->logo.jpg" title="华良财富标志"  /></a>
    ...
    <div class="lr_banner_body">
        ...
        <div class="lr_log">
            ...
            <dl>
                ...
                <dd>
                    <span><img src="<!--{IMG_PATH}-->lr_mob_icon.jpg"  /></span>
            ...
            <dl>
                ...
                <dd>
                    <span><img src="<!--{IMG_PATH}-->lr_password_icon.jpg" /></span>
            ...
            <a href="index.php?c=customer&a=register" title="十秒快速注册" class="lr_log_regbtn"></a>
        </div>
      </form>
...
<div class="lr_footer">
    <div>
        <p>Copyright © 2014 华良财富 1caifu.com All Rights Reserved 版权所有  浙ICP备12023130号-2 </p>
        <span><img src="<!--{IMG_PATH}-->footer_tel.jpg" title="咨询热线"  /></span>
    </div>
</div>
</body>
</html>
