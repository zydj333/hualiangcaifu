		...
		<div class="product-summary fix">
			<div class="product-info-box">
				...
				<div class="jxprojg">
					...
					<tr><td width="85" align="right" class="jgbtwz" height="26">行业价：</td><td class="jgwz1">¥<span id="show_hyprice"><!--{$goods_info['goods_shop_price_interval']}--></span><!--{if !empty($goods_info['ispromotion'])}--><em class="tm-promo-type "><s></s>促销</em><!--{/if}--></td></tr>
						<tr><td height="10"></td></tr>
						<tr><td align="right" class="jgbtwz" height="26">经销商价格：</td><td class="jgwz2">¥<span id="show_jxsprice"><!--{$goods_info['goods_shop_price_interval']}--></span><!--{if !empty($goods_info['ispromotion'])}--><em class="tm-promo-type "><s></s>促销</em><!--{/if}--></td></tr>
						<tr><td height="10"></td></tr>
						<!--{else}-->
						<tr><td width="85" align="right" class="jgbtwz" height="26">行业价：</td><td class="jgwz2">¥<span id="show_hyprice"><!--{$goods_info['goods_shop_price_interval']}--></span><!--{if !empty($goods_info['ispromotion'])}--><em class="tm-promo-type "><s></s>促销</em><!--{/if}--></td></tr>
						<tr><td height="10"></td></tr>
						<!--{/if}-->
						<!--{if !empty($tons_list)}-->
