...
<div class="sntop">
	...
	<div class="snnav">	
        ...
        <div class="bjsjwz">北京时间：<script language="javascript">showDate()</script> <img src="<!--{IMG_PATH}-->snline.gif" style="vertical-align:middle" /></div><div class="sechbg"><input type="text" name="search_keywords" id="search_keywords" value="" placeholder="请输入关键字"  class="serch" style="color:#aaa;" /><input type="image" src="<!--{IMG_PATH}-->sercbt.gif" style="vertical-align:middle" onclick="javascript:checksearch();return false;" /></div><div class="gwcbt"><img src="<!--{IMG_PATH}-->snline.gif" style="vertical-align:middle" /> <img src="<!--{IMG_PATH}-->gwcico.gif" style="vertical-align:middle" /> <a href="index.php?c=cart&a=cart_step1">购物车</a><img src="<!--{IMG_PATH}-->snline.gif" style="vertical-align:middle" /> EN &nbsp;&nbsp;中文<img src="<!--{IMG_PATH}-->snline.gif" style="vertical-align:middle" /></div><div class="clear"></div>
    </div>
