...
<div class="mntopbg"><span class="info_navzi2"><!--{$cate_info['ac_name']}--></span>
          <div class="flast_nav2">您现在的位置：<a href="index.php" class="grey">首页</a> > <a href="index.php?c=cases&a=lists&cid=4" class="grey">成功案例</a> > <span class="font_red"><!--{$cate_info['ac_name']}--></span></div></div>
  ...
  <div class="main_con clearfix">
    <div class="main_con_left"> <img src="<!--{IMG_PATH}-->left_img.png" class="font_size fix div_block" /> <img src="<!--{IMG_PATH}-->news_img4.jpg" class="font_size fix div_block" />
      <ul class="left_menu">
        ...
        <!--{foreach $data $v}-->
        <li <!--{if $article_info['ac_id'] == $v['ac_id']}-->class="current"<!--{/if}-->><a href="index.php?c=cases&a=lists&cid=<!--{$v['ac_id']}-->"><!--{$v['ac_name']}--></a></li>
        <!--{/foreach}-->
       	<!--{/cc}-->
