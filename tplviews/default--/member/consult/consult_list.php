...
<div class="mntopbg"><span class="info_navzi2">我的投诉</span>
          <div class="flast_nav2">您现在的位置：<a href="index.php" class="grey">首页</a> > <a href="index.php?m=member&c=user&a=index" class="grey">客户专区</a> > <span class="font_red">我的投诉</span></div></div>
  ...
  <div class="dindan">
  	<div class="dindtop"><h3 style="float:left; width:200px; font-size:14px; color:#666666;">我的投诉</h3><span style="float:right; width:200px; padding-right:10px; text-align:right; font-size:14px;"><h10><a href="index.php?m=member&c=consult&a=add">[我要投诉]</a></h10></span></div>
  	<div class="dindcon">
  		<table width="98%" cellpadding="0" cellspacing="0" border="1" bordercolor="#e8e7e7" align="center">
  			<tr>
  				<th align="center" width="50%" height="30">投诉内容</th>
  			...
  			<!--{foreach $list $v}-->
  			<tr>
  				<td align="left" height="28" style="line-height:20px;"><!--{$v['consult_content']}--></td>
  				<td align="center"><!--{date('Y-m-d H:m:s', $v['consult_addtime'])}--></td>
  				<td align="center"><!--{if empty($v['consult_reply'])}-->未回复<!--{else}-->已回复<!--{/if}--></td>
  				<td align="center" style="line-height:22px; font-size:13px;"><a href="index.php?m=member&c=consult&a=aview&id=<!--{$v['consult_id']}-->" class="grey2">查看</a> | <a href="index.php?m=member&c=consult&a=del&id=<!--{$v['consult_id']}-->" class="grey2">删除</a></td>
  			</tr>
    		<!--{/foreach}-->
  		</table>
  	</div>
