  ...
  <div class="dindan">
  	...
  	<div class="dindcon">
  		<table width="98%" cellpadding="0" cellspacing="0" border="1" bordercolor="#e8e7e7" align="center">
  			<tr>
  				<th align="center" width="50%" height="30">信息标题</th>
  				<th align="center" width="20%">发送时间</th>
  				<th align="center" width="15%">操作</th>
  			</tr>
  			<!--{foreach $list $v}-->
  			<tr>
  				<td align="left" height="28" style="line-height:20px;"><!--{if !empty($v['isread'])}--><!--{$v['message_title']}--><!--{else}--><strong><!--{$v['message_title']}--></strong><!--{/if}--></td>
  				<td align="center"><!--{date('Y-m-d H:m:s', $v['message_time'])}--></td>
  				<td align="center" style="line-height:22px; font-size:13px;"><a href="index.php?m=member&c=notice&a=aview&id=<!--{$v['message_id']}-->" class="grey2">查看</a> | <a href="index.php?m=member&c=notice&a=del&id=<!--{$v['message_id']}-->" class="grey2">删除</a></td>
  			</tr>
    		<!--{/foreach}-->
  		</table>
  	</div>
