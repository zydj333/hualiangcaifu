  ...
  <div class="dindan">
  	<div class="dindtop"><h3 style="float:left; width:200px; font-size:14px; color:#666666;">收货地址</h3></div>
		<div class="pcadd">
  		...
  		<input type="hidden" name="addressid" value="<!--{$addressInfo['address_id']}-->">
					...
					<td valign="top">
						<table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#dddddd" align="center">
							<tr>
								...
								<td><input type="text" name="true_name" id="true_name" value="<!--{$addressInfo['true_name']}-->" class="khinput2" style="width:150px;" />&nbsp;<font color="red">*</font></td>
							</tr>
							<tr>
								...
								<td>
  								...
  								<!--{foreach $area $v}-->
  									<option value="<!--{$v['id']}-->" <!--{if $addressInfo['province_id'] == $v['id']}-->selected<!--{/if}-->><!--{$v['name']}--></option>
  								<!--{/foreach}-->
  								</select>
							...
							<tr>
								...
								<td><input type="text" name="address" id="address" value="<!--{$addressInfo['address']}-->" class="khinput2" style="width:300px;" />&nbsp;<font color="red">*</font></td>
							</tr>
							<tr>
								<th width="100" align="right" height="28">邮编：</th>
								<td><input type="text" name="zip_code" id="zip_code" value="<!--{$addressInfo['zip_code']}-->" class="khinput2" style="width:200px;" /></td>
							</tr>
							<tr>
								<th width="100" align="right" height="28">移动电话：</th>
								<td><input type="text" name="mob_phone" id="mob_phone" value="<!--{$addressInfo['mob_phone']}-->" class="khinput2" style="width:200px;" />&nbsp;<font color="red">*</font></td>
							</tr>
							<tr>
								<th width="100" align="right" height="28">固定电话：</th>
								<td><input type="text" name="tel_phone" id="tel_phone" value="<!--{$addressInfo['tel_phone']}-->" class="khinput2" style="width:200px;" /></td>
							</tr>
							<tr>
								<th width="100" align="right" height="28">默认地址：</th>
								<td><input value="1" style="width:20px" name="d_add" id="d_add" type="checkbox" <!--{if !empty($addressInfo['d_add'])}-->checked<!--{/if}-->></td>
							</tr>
							<script language="javascript">
      					setup(<!--{$addressInfo['province_id']}-->,<!--{$addressInfo['city_id']}-->,<!--{$addressInfo['area_id']}-->);
      				</script>
						</table>
					</td>
				</tr>
