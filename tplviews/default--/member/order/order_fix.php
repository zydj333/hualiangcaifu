...
<div class="main_body">
<div class="mntopbg"><span class="info_navzi2">返修记录</span>
          <div class="flast_nav2">您现在的位置：<a href="index.php" class="grey">首页</a> > <a href="index.php?m=member&c=user&a=index" class="grey">客户专区</a> > <span class="font_red">返修记录</span></div></div>
  ...
  <div class="pencetr">
	...
	<div><input name="a" value="" type="text" placeholder="请输入返修编号或订单编号搜索" class="ordertx"/><input name="b" type="button"  value="订单搜索" class="orderbt" /></div>
	<div style="margin-top:15px;">
  <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#e6e6e6" align="center" class="reftab">
	<tr><th height="31">返修编号</th><th>订单编号</th><th>商品名称</th><th>申请时间</th><th>状态</th><th>操作</th></tr>
	...
	<tr>
		...
		<td align="center" width="10%" style="line-height:24px;"><a href="index.php?m=member&c=order&a=viewfix&rid=<!--{$v['returns_id']}-->" class="wblue">查看</a><br>
			<!--{if $v['re_state']==1}--><a href="index.php?m=member&c=order&a=canfix&rid=<!--{$v['returns_id']}-->" class="wblue">取消</a><!--{/if}-->
		</td>
	</tr>
	<!--{/foreach}-->
	</table>
