            ...
            <div class="content">
                ...
                <div class="content_body">
                   ...
                   <div class="mall_xq_top">
                       <div class="mall_xq_top_lt">
                           <table width="100%" border="0" cellpadding="0" cellspacing="0">
                               <tr>
                                   <td><img src="/<?php echo $points_info['points_image'];?>"  /></td>
                               </tr>
                           </table>
                       </div>
                       <div class="mall_xq_top_rt">
                           <h4><?php echo $points_info['name'];?></h4>
                           <font>市场参考价格：<?php echo $points_info['market_price'];?>元</font>
                           <span>所需积分<strong><?php echo $points_info['points'];?></strong>分</span>
                   ...
                   <div class="mall_xq_body">
                    ...
                    <div><?php echo $points_info['content'];?></div>
