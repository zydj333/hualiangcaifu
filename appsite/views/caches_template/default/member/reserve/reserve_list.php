    ...
    <table width="780" height="187" border="0" cellpadding="0" cellspacing="0"   style="margin-left:3px;">
      <tr>
        <td valign="top" style="border:1px solid #fff;"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="margin-top:5px;">
          <tr>
            <td width="10%" height="26" background="<?php echo IMG_PATH;?>titlebg.jpg"><div align="center"><strong> 预约日期</strong></div></td>
            <td width="22%" background="<?php echo IMG_PATH;?>titlebg.jpg"><div align="center"><b>产品名称</b></div></td>
            <td background="<?php echo IMG_PATH;?>titlebg.jpg" class="auto-style2"><div align="center"><div align="center"><strong>姓名</strong></div></div></td>
            <td width="14%" background="<?php echo IMG_PATH;?>titlebg.jpg"><div align="center" class="STYLE3"><div align="center">电话</div></div></td>
            <td width="15%" background="<?php echo IMG_PATH;?>titlebg.jpg"><div align="center" class="STYLE3"><div align="center">EMAIL </div></div></td>
            <td width="9%" background="<?php echo IMG_PATH;?>titlebg.jpg"><div align="center"><b>预定金额</b></div></td>
            <td width="12%" background="<?php echo IMG_PATH;?>titlebg.jpg"><div align="center"><b>备注</b></div></td>
            <td width="7%" background="<?php echo IMG_PATH;?>titlebg.jpg"><div align="center"><b>状态</b></div></td>
          </tr>
          <?php if(is_array($list)) foreach($list AS $v) { ?>
					<tr>
						<td><?php echo $v['reserve_date'];?></td>	
