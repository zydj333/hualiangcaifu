...
<link href="<?php echo CSS_PATH;?>user_620.css" type="text/css" rel="stylesheet" />   
<div class="user_620">
    <!--lt-->
    <div class="user_lt">
    ...
    <div class="user_rt">
        ...
        <div class="user_rt_layout">
            ...
            <div class="user_mag_mp">
                <span>
                    <img src="<?php echo IMG_PATH;?>fuwujingli.jpg" style="width:120px; height:120px;"  />
                </span>
                <div>
                    <ul>
                        <li>服务经理：张有钢</li>
            ...
            <table class="user_rt_table_01" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <th width="12%">状态</th>
								...
								<?php if(is_array($reserve_list)) foreach($reserve_list AS $v) { ?>
								<tr>
        ...
        <div class="user_rt_layout">
            <h3 style="float:left">
                <img src="<?php echo IMG_PATH;?>user_lcs_pic04.png" />
             ...
             <table  cellpadding="0" cellspacing="0" class="user_rt_table_01">
                ...
                <tr>
										<td><?php echo $v['name'];?></td>	
										<td><?php if($v['real_money']) { ?><?php echo $v['real_money'];?><?php } ?></td>
										<td><?php echo $v['product_name'];?></td>	
										<td><?php echo $v['dk_date'];?></td>
										<td><?php echo $v['real_date'];?></td>	
