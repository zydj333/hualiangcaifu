...
<link href="<?php echo CSS_PATH;?>user_620.css" rel="stylesheet" type="text/css" />
<script src="<?php echo JS_PATH;?>jquery-1.7.2.min.js"></script>
<script src="<?php echo JS_PATH;?>jquery-ui.min.js"></script>
<link href="<?php echo CSS_PATH;?>jquery.ui.all.css" rel="stylesheet" />
<script src="<?php echo JS_PATH;?>jquery.autocomplete.js"></script>
<link href="<?php echo CSS_PATH;?>jquery.autocomplete.css" rel="stylesheet" />
            ...
            <table width="100%" class="user_form" cellpadding="0" cellspacing="0">
                	...
                	<tr>
                    	...
                    	<td width="87%">
                  			...
                  			<img src="<?php echo IMG_PATH;?>1.jpg" id="imgs" name="imgs" width="60" height="40" />
                  		</td>
                	</tr>
                 	<tr>
                    ...
                    <td width="87%">
                   		...
                   		<img src="<?php echo IMG_PATH;?>2.jpg" id="imgs1" name="imgs1" width="60" height="40" />
                   	</td>
                	</tr>
                  <tr>
                    ...
                    <td width="87%">
                    	...
                    	<img src="<?php echo IMG_PATH;?>3.jpg" id="imgs2" name="imgs2" width="60" height="40" />
                    </td>
                	</tr>
                  <tr>
                    <td width="87%">
                 			<input name="idcard_back" id="idcard_back" type="file" class="type-file-file" style="width:300px;" />
                    	<img src="<?php echo IMG_PATH;?>4.jpg" id="imgs3" name="imgs3" width="60" height="40" />
                    </td>
                	</tr>
                  <tr>
                    ...
                    <td width="87%">
                    	...
                    	<img src="<?php echo IMG_PATH;?>5.jpg" id="imgs4" name="imgs4" width="60" height="40" />
                    </td>
                		</tr>
                  	<tr>
                    	<td width="87%">
                      	<input name="signature2" id="signature2" type="file" class="type-file-file" style="width:300px;" />
                    		<img src="<?php echo IMG_PATH;?>6.jpg" id="imgs5" name="imgs5" width="60" height="40" />
                    	</td>
                		</tr>
                		<tr>
