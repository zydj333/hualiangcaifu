...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript">
            ...
            function checkform()
            {
                ...
                var mingpian = document.getElementById("coverimage").value;
                var msg = "";
    ...
    <body>
        ...
        <div class="body_mid">
            ...
            <div class="reg_lt">
                ...
                <div class="reg_lt_dpic">
                    <img src="<?php echo IMG_PATH; ?>lr_dao_01.png" title="填写注册信息"  />
                </div>
                <!--注册表单-->
                <form action="" method="post" onsubmit="return checkform();" >
                    <input type="hidden" name="dosubmit" value="1">
                        <div class="reg_form">
                            <h4>为了保障您的账户安全，财来电需要进行手机验证（以下信息除[推荐人手机]外均需填写完整）。我们会对您的个人信息严格保密。</h4>
                            <ul>
                                <li>
                                    <label>手机号码：</label>
                                ...
                                <li>
                                    <label>名片：</label>
                                    <input name="fileToUpload" id="fileToUpload" type="file" style="width:77px" onchange="return ajaxFileUpload();"/> 
                                    <span id="upload_img"><img class="idimg fl ml10" src="<?php echo IMG_PATH; ?>card.jpg" /></span>
                                    <input name="image_url" id="coverimage" type="hidden" value=""/>
                                    <label style="float:left;margin-left:0; display:none; "  id="loading"><img src="<?php echo IMG_PATH; ?>loading.gif"/></label>
                                </li>
                                <li>
                                    <label>验证码：</label>
                                    <input name="yzcode" id="yzcode" type="text" value="" onblur="check_code(this.value);" class="khinput2" style="width:150px;" />
                                    <img id='code_img' style=" vertical-align:middle; border:1px solid #dddddd;" onclick='this.src = this.src + "&" + Math.random()' src='<?php echo BASE_URL; ?>index.php?m=com&c=common&a=verifycode&vcode=login_verifycode&code_len=4&font_size=15&width=90&height=38&font_color=&background=' title="看不清,点击更换验证码">
                                </li>
                            </ul>
                            <span>  我已经阅读并同意 <a href="#TB_inline?height=500&width=550&inlineId=myOnPageContent" title="  《用户使用协议》及《隐私保护协议》。 " class=".html"  > 《用户使用协议》及《隐私保护协议》。 </a>
                                <div id='myOnPageContent' style="display:none;"> <p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">本协议由您与财来电会员系统的经营者共同缔结，本协议具有合同效力。</span></p><p style="text-align: left; line-height: 20px; margin-top: auto; margin-bottom: auto;"><span style="font-size: 12px;"><span style="color: rgb(51, 51, 51); font-family: Symbol; font-size: 13px;">·<span style="font: 9px/normal &quot;Times New Roman&quot;; font-size-adjust: none; font-stretch: normal;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">一、财来电会员系统使用规范： </span></span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">1. 您根据财来电会员系统的理财资讯向客户进行推广宣传业务的，需保证客户是符合相关法律规定的投资人。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">2. 您应严格按照国家各金融监管机构的规定开展业务活动，不采用误导或可能误导客户的方式和内容进行宣传推广。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">3. 您保证在接到客户的投诉后，积极妥善处理。您与客户的一切纠纷，均与财来电会员系统经营者无关。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">4. 财来电会员系统中的资料信息，仅供推广业务参考，未得财来电会员系统经营者同意，不得将之在业务范围外交予第三方使用。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">5. 财来电会员系统经营者与您不具有雇佣、代理等关系，您不得利用财来电的名称或公司数据（包括但不限于地址及电话等），行不实夸大之宣传而误导客户及其他损害客户利益的行为。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">6. 您在推广活动中，不得利用不正当竞争手段、恶意手段发展客户。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">7. 您提交的注册信息及您设置的银行卡信息，都将严格进行保密。除法律另有规定或监管机构要求披露外，财来电会员系统均不会任意对外泄露。</span></p><p style="text-align: left; line-height: 20px; margin-top: auto; margin-bottom: auto;"><span style="font-size: 12px;"><span style="color: rgb(51, 51, 51); font-family: Symbol; font-size: 13px;">·<span style="font: 9px/normal &quot;Times New Roman&quot;; font-size-adjust: none; font-stretch: normal;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">二、协议内容及签署： </span></span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">1. 本协议内容包括协议正文及所有财来电会员系统已经发布的或将来可能发布的各类规则。所有规则为本协议不可分割的组成部分，与协议正文具有同等法律效力。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">2. 您应当在使用财来电会员系统服务之前认真阅读全部协议内容，对于协议中以加粗字体显示的内容，您应重点阅读。如您使用财来电会员系统服务，则本协议即对您产生约束，届时您不应以未阅读本协议的内容为由，主张本协议无效，或要求撤销本协议。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">3. 您承诺接受并遵守本协议的约定。如果您不同意本协议的约定，您应立即停止注册使用财来电会员系统。如果您注册完成本平台，将被视为接受本协议全部条款，接受本协议约束。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">4. 财来电会员系统有权根据需要不时地制订、修改本协议及/或各类规则，并以网站公示的方式进行公告，不再单独通知您。变更后的协议和规则一经在网站公布后，立即自动生效。如您不同意相关变更，应当立即停止使用财来电会员系统服务。您继续使用财来电会员系统服务的，即表示您接受经修订的协议和规则。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">5. 财来电会员系统即财来电提供给您用于查看理财资讯、进行专业投资管理服务的平台。</span></p><p style="text-align: left; line-height: 20px; margin-top: auto; margin-bottom: auto;"><span style="font-size: 12px;"><span style="color: rgb(51, 51, 51); font-family: Symbol; font-size: 13px;">·<span style="font: 9px/normal &quot;Times New Roman&quot;; font-size-adjust: none; font-stretch: normal;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">三、违约责任 </span></span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">您未按本协议约定履行其义务，出现违反上述条款之一的，财来电会员系统经营者有权终止支付服务费。情节严重的，财来电会员系统经营者有权单方终止本协议。协议终止后，财来电会员系统经营者依旧有权要求您承担违约责任。</span></p><p style="text-align: left; line-height: 20px; margin-top: auto; margin-bottom: auto;"><span style="font-size: 12px;"><span style="color: rgb(51, 51, 51); font-family: Symbol; font-size: 13px;">·<span style="font: 9px/normal &quot;Times New Roman&quot;; font-size-adjust: none; font-stretch: normal;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">四、其他约定 </span></span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">1. 本协议之效力、解释、变更、执行与争议解决均适用中华人民共和国大陆地区法律，如无相关法律规定的，则应参照通用国际商业惯例和（或）行业惯例。</span></p><p style="text-align: left; line-height: 20px;"><span style="color: rgb(51, 51, 51); font-family: 宋体; font-size: 12px;">2. 因本协议产生之争议的，您与财来电会员系统经营者均同意以财来电会员系统经营者住所地人民法院为管辖法院。</span></p><p><span style="font-family: Calibri; font-size: 12px;">&nbsp;</span></p><p>&nbsp;</p> </div> </span>
        ...
        <script src="<?php echo JS_PATH; ?>ajaxfileupload.js" type="text/javascript"></script>
        <script type="text/javascript">
            function ajaxFileUpload() {
                ...
                $.ajaxFileUpload({
                                    url: 'index.php?c=image&a=upload',
                                    secureuri: false,
                                    fileElementId: 'fileToUpload',
                                    dataType: 'json',
                                    data: {imagetype: 'mingpian'},
                                    success: function(data, status)
                                    {
                                        if (data.flag == 0) {
                                            alert(data.error);
                                        } else {
                                            var temp = '<img src="/' + data.imgurl_thumb + '" class="idimg fl ml10" />';
