...
<div id="LoginBox"  >
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="3">
        <tr>
            ...
            <td height="30">
                <input type="text" name="mtitle" id="mtitle" class="inps" value="<?php echo $product_info['id']; ?>" style="display:none">
...
<div class="new_cp_header">
    ...
    <div class="new_pro_main">
        <div class="new_cp_header_lt">
            <h2><span class="title"><?php echo $product_info['name']; ?></span>                
                <img src="<?php echo IMG_PATH; ?>pd-mark.png" class="imark" />
            </h2>
            <div>
                <span class="pro_new_title">年化收益：</span>
                <span class="pro_new_cont" style="font-family:Verdana"><?php echo $product_info['yield_year']; ?></span>
                <span class="pro_new_title">收益类型：</span>
                <span class="pro_new_cont"><?php echo $product_info['earning_name']; ?></span>
            </div>
            <div>
                <span class="pro_new_title">付息方式：</span>
                <span class="pro_new_cont"><?php echo $product_info['interest_name']; ?></span>
                <span class="pro_new_title">产品期限：</span>
                <span class="pro_new_cont" style="font-family:Verdana"><?php echo $product_info['lifetime']; ?>个月</span>
            </div>
            <div>
                <span class="pro_new_title">大小配比：</span>
                <span class="pro_new_cont"><?php echo $product_info['size_name']; ?></span>
                <span class="pro_new_title">进&nbsp; 度：</span>
                <span class="pro_new_cont" style="font-family:Verdana">
                    <div class="load_list" style="margin-left:5px;width:180px;padding:0;"><i style="width:<?php echo $product_info['progress_percent']; ?>%"></i><font><?php echo $product_info['progress_percent']; ?>%</font></div>
            ...
            <div>
                ...
                <span class="pro_new_cont" style="font-family:Verdana">  
                    <?php if (isset($this->session->userdata['member_user_id']) && $this->session->userdata['member_user_id']) { ?>
                        <?php echo $product_info['fee_scale']; ?>
                    <?php } else { ?>
                        <a href="index.php?c=customer&a=login" class="index_cp_look" style="width:60px;"  >登录可见</a>
                    <?php } ?>
                </span>
                <span class="pro_new_title">募集进度：</span>
                <span class="pro_new_cont" style="font-family:Verdana"><?php echo mb_substr($product_info['progress'], 0, 50); ?></span>
            </div>
        </div>
        <div class="new_cp_header_rt" style="margin-left:-10px;">
            <h2><b>我要预约</b><span style="margin-left:-20px;"><img src="<?php echo IMG_PATH; ?>tel.jpg" style="width:150px; height:23px;"  /></span></h2>
            <form action="" method="post" onsubmit="return checkform();" >
                ...
                <div>
                    ...
                    <input type="submit" name="Button1" value="立即预约" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions( & quot; Button1 & quot; , & quot; & quot; , true, & quot; & quot; , & quot; & quot; , false, false))" id="Button1" class="pro_new_btn" />
                    &nbsp;</div>
            </form>
        </div>
    </div>
...
<div class="subpage">
    ...
    <div class="content">
        ...
        <div class="content_body">
            ...
            <div class="cpxq_btn">
                <?php if (isset($this->session->userdata['member_user_id']) && $this->session->userdata['member_user_id']) { ?>
                    <a href="javascript:;" title="<?php echo $product_info['name']; ?>" ids="<?php echo $product_info['id']; ?>" class="cpxq_btn_email about"></a>
                    <a href="<?php echo $product_info['download']; ?>" class="cpxq_btn_download" title="资料下载"> </a>
                <?php } else { ?>
            ...
            <table width="100%" class="cpxq_table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="317">
                        <h4 style="font-size:14px; padding-left:25px;"><?php echo $product_info['name']; ?></h4>
                    </td>
                    <td width="160" class="cpxq_tb_title">发行机构</td>
                    <td width="317">
                        <span><?php echo $product_info['issuer']; ?></span>
                    </td>
                </tr>
                <tr>
                    <td width="160" class="cpxq_tb_title">产品类别</td>
                    <td width="317">
                        <span><?php echo $product_info['category_name']; ?></span>
                    </td>
                    <td width="160" class="cpxq_tb_title">投资领域</td>
                    <td width="317">
                        <span><?php echo $product_info['investment_name']; ?></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="317">
                        <span class="ft"><font class="ft"><?php echo $product_info['scale']; ?></font>亿</span>
                    </td>
                    <td width="160" class="cpxq_tb_title">投资门槛</td>
                    <td width="317">
                        <span>
                            <font class="ft"><?php echo $product_info['threshold']; ?>万</font>
                        </span> 
                    </td>
                </tr>
