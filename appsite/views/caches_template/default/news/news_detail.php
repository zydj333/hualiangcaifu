    ...
    <div class="rt">
        ...
        <div class="sub_main">
           <div class="news_title">
               <h1 style="text-align:center;font-size:16px;"><?php echo $article_info['article_title'];?></h1>
               <p>时间：<?php echo date('Y-m-d H:m:s', $article_info['article_time']);?> 由华良财富编辑发布 </p>
           </div>
           <div class="news_det">
               <p>
               <p><?php echo $article_info['article_content'];?></p><p><br/></p>
               </p>
