...
class ipaging {
	...
	public function getmemberbar($total_rows=0,$cur_page=0,$pagesize=20,$base_url='',$num_link=3){
		...
		//$config['cur_page'] = 8;//$cur_page;//当前页
	    ...
	    //配置添加封装标签
		//如果你希望在整个分页周围围绕一些标签
		$config['full_tag_open'] = '<div class="page pagges">';
		...
		$config['first_tag_num_open']='<span>';
		$config['first_tag_num_close']='</span>';

		$config['last_link'] = '末页';
		$config['last_tag_open'] = '';
		$config['last_tag_close'] = '';
		$config['last_tag_num_open']='<span>';
		$config['last_tag_num_close']='</span>';

		$config['next_link'] = '下一页';
		$config['next_tag_open'] = '';
		$config['next_tag_close'] = '';
		$config['next_tag_num_open']='<span>';
		$config['next_tag_num_close']='</span>';

		$config['prev_link'] = '上一页';
		$config['prev_tag_open'] = '';
		$config['prev_tag_close'] = '';
		$config['prev_tag_num_open']='<span>';
		$config['prev_tag_num_close']='</span>';

		$config['loop_tag_num_open']='<span>';
		$config['loop_tag_num_close']='</span>';
	...
	public function getSysPageBar_bakk($total_rows=0,$cur_page=0,$pagesize=20,$base_url='',$num_link=3){
		...
		//配置添加封装标签
		//如果你希望在整个分页周围围绕一些标签
		$config['full_tag_open'] = '<div class="page pagges"><ul><li><span>共'.$total_rows.'条</span></li>';
