$(function(){
    ...
    $('*[ectype="gselector"]').focus(function(){
        ...
        var type = $(this).attr('ectype');
        var store_id = $(this).attr('gs_store_id');
        var title = $(this).attr('gs_title') ? $(this).attr('title') : '';
        var width = $(this).attr('gs_width');
        ajax_form(id, title, SITE_URL + '/index.php?m=member&c=groupbuy&a=gselector&act=' + type + '&dialog=1&title=' + title + '&store_id=' + store_id+ '&id=' + id + '&name=' + name + '&callback=' + callback, width);
        return false;
    });
